...
public class MainActivity extends AppCompatActivity {
        ...
        public void onClick(View view) {
            ...
            if (searchNumber != null) {
                ...
                if (resultSearch == null) { // если в поэме ничего не найдено, то
                    output.setText("Строки с данной длиной слова в поэме не найдено");
                } else {
    ...
    private String searchMapPoem(Integer search, Map<Integer, String> map) {
        ...
        for (Integer key: map.keySet()) { // перебор мап по ключам
            String[] words = map.get(key).replaceAll("[^а-яА-Я ]+", "").replaceAll("\\s+", " ").split(" ");
            for (String word: words) {
                if(word.length() == search) { // если в строке с ключом key имеется фраза поиска, то
        ...
        if (count == 0) {
            ...
            return count + " слов введённой длины в следующих строках:" + result; // вывод количества найденных в поэме фраз и подстрок поэмы, где они были найдены
        }
    }
